...
- **Next (T4.4 Inc 2):** drill-down panel in `PackageModDoctor.tsx` — click a collision finding → fetch `/api/agent/override-map` → render per-element claims + winner.

## Tier 4 — ecosystem levers (proposed 2026-06-12; T4.4 IN PROGRESS — Inc 1 shipped)
